    ...
    DUNGEONS: [
        {zoneName: 'DA', zoneID: [2105, 3102], bosses: {
                1000: [
                    ...
                    {id: 110, msg: 'Quantum Wave', spawns: [
                        {type: 'circle', pointDegrees: 0, pointRadius: 0, item: ITEM_EGG, time: 4000, intervalDegrees: 8, radius: 640, timeout: 0}
                    ], timeout: 0},
                    ...
                    {id: 121, msg: 'Purple Magic ([color="red"]Right Foot[/color], Inner donut first)', spawns: [
                        {type: 'circle', pointDegrees: 0, pointRadius: 0, item: ITEM_CYLINDER, time: 3000, intervalDegrees: 8, radius: 540, timeout: 0}
                    ], timeout: 0},
                    {id: 124, msg: 'Purple Magic ([color="red"]Left Foot[/color], Outer donut first)', spawns: [
                        {type: 'circle', pointDegrees: 0, pointRadius: 0, item: ITEM_CYLINDER, time: 3000, intervalDegrees: 8, radius: 540, timeout: 0}
                    ], timeout: 0},
